      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10">
              ...
              <p className="mb-8 max-w-[270px] text-base leading-relaxed text-gray-600">
              ...
              <ul className="space-y-1">
                {[
                  ...
                  <li key={label}>
                    <a
                      href={href}
                      className="mb-3 inline-block text-base text-gray-600 hover:text-primary transition-colors"
                    >
                      {label}
                    </a>
                  </li>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="mb-10">
              <h4 className="mb-9 text-lg font-semibold text-gray-900">Quick Links</h4>
              <ul className="space-y-1">
                {[
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12 xl:w-3/12">
            <div className="mb-10">
              <h4 className="mb-9 text-lg font-semibold text-gray-900">Contact Us</h4>
              <ul className="space-y-4">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <a href="mailto:support@bootway.in" className="text-sm text-gray-600 hover:text-primary transition-colors">
                    support@bootway.in
                  </a>
                </li>
                <li className="flex items-center gap-3">
                  ...
                  <a href="tel:+917976866822" className="text-sm text-gray-600 hover:text-primary transition-colors">
                    +91 797 686 6822
                  </a>
                </li>
              </ul>
        ...
        >
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/admin/login" className="text-sm text-gray-600 hover:text-primary transition-colors">
              HR Login
            </Link>
          </div>
        </div>
